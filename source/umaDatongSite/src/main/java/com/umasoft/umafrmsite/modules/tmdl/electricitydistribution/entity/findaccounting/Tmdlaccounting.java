 ...
 */
package com.umasoft.umafrmsite.modules.tmdl.electricitydistribution.entity.findaccounting;
 ...
 * @version 2018-07-24
 */
public class Tmdlaccounting extends DataEntity<Tmdlaccounting> {
	...
	public Tmdlaccounting() {
		super();
	}

	public Tmdlaccounting(String id){
		super(id);
	}
