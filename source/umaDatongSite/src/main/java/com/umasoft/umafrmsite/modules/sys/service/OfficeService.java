...
import com.umasoft.umafrmsite.common.service.TreeService;
import com.umasoft.umafrmsite.modules.sys.dao.OfficeDao;
...
public class OfficeService extends TreeService<OfficeDao, Office> {
	...
	@Transactional(readOnly = true)
	public List<Office> findOfficeByCode(Office code){
		
		return dao.findByOfficeCode(code);
