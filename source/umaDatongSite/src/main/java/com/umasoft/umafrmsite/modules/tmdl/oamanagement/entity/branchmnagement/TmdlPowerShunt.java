 ...
 */
package com.umasoft.umafrmsite.modules.tmdl.oamanagement.entity.branchmnagement;
 ...
 * @version 2018-07-06
 */
public class TmdlPowerShunt extends DataEntity<TmdlPowerShunt> {
	...
	private UserCompany unitId;		// 单位代码
	...
	public TmdlPowerShunt() {
		super();
	}

	public TmdlPowerShunt(String id){
		super(id);
	}
