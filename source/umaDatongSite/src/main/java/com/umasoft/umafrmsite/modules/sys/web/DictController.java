...
import com.umasoft.umafrmsite.modules.sys.service.DictService;
...
public class DictController extends BaseController {
	...
	public Page<Dict> listData2(Dict dict, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<Dict> page = dictService.findPage(new Page<Dict>(request, response), dict); 
		return page;
	}
}
