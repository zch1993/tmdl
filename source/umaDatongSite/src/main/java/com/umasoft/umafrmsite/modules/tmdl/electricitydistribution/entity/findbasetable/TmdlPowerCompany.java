 ...
 */
package com.umasoft.umafrmsite.modules.tmdl.electricitydistribution.entity.findbasetable;
 ...
 * @version 2018-07-18
 */
public class TmdlPowerCompany extends DataEntity<TmdlPowerCompany> {
	...
	public TmdlPowerCompany() {
		super();
	}

	public TmdlPowerCompany(String id){
		super(id);
	}
