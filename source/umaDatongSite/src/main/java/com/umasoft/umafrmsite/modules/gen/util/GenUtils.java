 ...
 */
package com.umasoft.umafrmsite.modules.gen.util;
...
import com.umasoft.umafrmsite.common.mapper.JaxbMapper;
import com.umasoft.umafrmsite.common.utils.DateUtils;
import com.umasoft.umafrmsite.common.utils.FileUtils;
import com.umasoft.umafrmsite.common.utils.FreeMarkers;
import com.umasoft.umafrmsite.common.utils.StringUtils;
import com.umasoft.umafrmsite.modules.gen.entity.GenCategory;
import com.umasoft.umafrmsite.modules.gen.entity.GenConfig;
...
//		}
	 ...
	 * @return
	 */
	public static GenConfig getConfigWorkFlow(){
		return fileToObject("configworkflow.xml", GenConfig.class);
	}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("hasWorkFlow", genScheme.getHasWorkFlow());
