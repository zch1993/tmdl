...
import com.umasoft.umafrmsite.modules.sys.service.OfficeService;
...
public class RoleController extends BaseController {
	...
	public String form(Role role, Model model) {
		...
		model.addAttribute("menuList", systemService.roleFindAllMenu());
	...
	public String save(Role role, Model model, RedirectAttributes redirectAttributes) {
		if(!UserUtils.getUser().isAdmin() && !"admin".equals( UserUtils.getUser().getLoginName()) &&role.getSysData().equals(Global.YES)){
