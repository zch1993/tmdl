 ...
 */
package com.umasoft.umafrmsite.modules.sys.security;
...
import com.umasoft.umafrmsite.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
        ...
        if(jwttoken!=null){
            ...
            if (username == null) {
                //throw new AuthenticationException("msg:token伪造");
            	username = token.getUsername();
            }
        	//throw new AuthenticationException("msg:没有token");
        }
        */
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		User user = getSystemService().getUserByLoginName(username);//principal.getLoginName());
		if (user != null) {
