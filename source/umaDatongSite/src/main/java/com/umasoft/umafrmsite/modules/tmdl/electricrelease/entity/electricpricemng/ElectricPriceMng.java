 ...
 */
package com.umasoft.umafrmsite.modules.tmdl.electricrelease.entity.electricpricemng;
 ...
 * @version 2018-07-06
 */
public class ElectricPriceMng extends DataEntity<ElectricPriceMng> {
	...
	public ElectricPriceMng() {
		super();
	}

	public ElectricPriceMng(String id){
		super(id);
	}
