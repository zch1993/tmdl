...
import com.umasoft.umafrmsite.common.security.Digests;
...
import com.umasoft.umafrmsite.common.service.ServiceException;
...
import com.umasoft.umafrmsite.common.web.Servlets;
import com.umasoft.umafrmsite.modules.sys.dao.MenuDao;
import com.umasoft.umafrmsite.modules.sys.dao.RoleDao;
import com.umasoft.umafrmsite.modules.sys.dao.UserDao;
import com.umasoft.umafrmsite.modules.sys.entity.Menu;
...
import com.umasoft.umafrmsite.modules.sys.security.SystemAuthorizingRealm;
import com.umasoft.umafrmsite.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Menu> roleFindAllMenu(){
		return UserUtils.roleGetMenuList();
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://www.umasoft.com\r\n");
		sb.append("\r\n======================================================================\r\n");
