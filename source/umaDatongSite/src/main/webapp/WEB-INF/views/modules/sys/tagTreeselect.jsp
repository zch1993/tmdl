...
<body>
	...
	<div id="search" class="form-group" >
		...
		<div class="input-group">
         <input type="text" class="form-control" id="key" name="key" maxlength="50" > <span class="input-group-btn"> <button id="btn" onclick="searchNode()" type="button" class="btn btn-primary">搜索
         </button> </span>
      </div>
	</div>
