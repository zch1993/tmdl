...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/electricitydistribution/findaccounting/tmdlaccounting/form?id=${tmdlaccounting.id}">核算表查询<shiro:hasPermission name="electricitydistribution:findaccounting:tmdlaccounting:edit">${not empty tmdlaccounting.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="electricitydistribution:findaccounting:tmdlaccounting:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	...
	<form:form id="inputForm" modelAttribute="tmdlaccounting" action="${ctx}/electricitydistribution/findaccounting/tmdlaccounting/save?searchUrlParam=${searchUrlParam}" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<form:input path="unitId" htmlEscape="false" maxlength="255" class="form-control "/>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input name="time" type="text" readonly="readonly" maxlength="20" class="form-control Wdate "
					value="<fmt:formatDate value="${tmdlaccounting.time}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-group"><div class="col-sm-4 col-sm-offset-2">
			<shiro:hasPermission name="electricitydistribution:findaccounting:tmdlaccounting:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
