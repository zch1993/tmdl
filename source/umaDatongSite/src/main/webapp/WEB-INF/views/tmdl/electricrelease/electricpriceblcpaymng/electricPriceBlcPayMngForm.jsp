...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/electricrelease/electricpriceblcpaymng/electricPriceBlcPayMng/form?id=${electricPriceBlcPayMng.id}">电价补差管理<shiro:hasPermission name="electricrelease:electricpriceblcpaymng:electricPriceBlcPayMng:edit">${not empty electricPriceBlcPayMng.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="electricrelease:electricpriceblcpaymng:electricPriceBlcPayMng:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	...
	<form:form id="inputForm" modelAttribute="electricPriceBlcPayMng" action="${ctx}/electricrelease/electricpriceblcpaymng/electricPriceBlcPayMng/saveSetAll?unitidparam=${unitidparam}&pagenoparam=${pagenoparam}&addtimeparam=${addtimeparam}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
tablecolumn="name:单位名称"  searchcolumn="name" checked="true" multiSelect="false"/>
		...
		<div class="form-group"><div class="col-sm-4 col-sm-offset-2">
			<shiro:hasPermission name="electricrelease:electricpriceblcpaymng:electricPriceBlcPayMng:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
