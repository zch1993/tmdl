...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/paramset/substationcompanyrelation/substationCompanyRelation/form?id=${substationCompanyRelation.id}">变电站和用电单位对应关系查看</a></li>
	</ul>
	...
	<form:form id="inputForm" modelAttribute="substationCompanyRelation" action="${ctx}/paramset/substationcompanyrelation/substationCompanyRelation/save?searchUrlParam=${searchUrlParam}" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<label class="control-label">${substationCompanyRelation.unitid.id|name	}		</label>	
			
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">变电站ID：</label>
			<div class="col-sm-10">
				<label class="control-label">${substationCompanyRelation.bdzid.id|name	}		</label>	
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<label class="control-label">${substationCompanyRelation.remarks	}</label>
