...
<body>
	...
	<form:form id="inputForm" modelAttribute="electricPriceMng" action="${ctx}/electricrelease/electricpricemng/electricPriceMng/saveSetAll?unitidparam=${unitidparam}&pagenoparam=${pagenoparam}&addtimeparam=${addtimeparam}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
