...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/electricitydistribution/findcollierygroup/tmdlCollieryGroup/form?id=${tmdlCollieryGroup.id}">煤业和集团查询<shiro:hasPermission name="electricitydistribution:findcollierygroup:tmdlCollieryGroup:edit">${not empty tmdlCollieryGroup.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="electricitydistribution:findcollierygroup:tmdlCollieryGroup:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	...
	<form:form id="inputForm" modelAttribute="tmdlCollieryGroup" action="${ctx}/electricitydistribution/findcollierygroup/tmdlCollieryGroup/save?searchUrlParam=${searchUrlParam}" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input name="time" type="text" readonly="readonly" maxlength="20" class="form-control Wdate "
					value="<fmt:formatDate value="${tmdlCollieryGroup.time}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-group"><div class="col-sm-4 col-sm-offset-2">
			<shiro:hasPermission name="electricitydistribution:findcollierygroup:tmdlCollieryGroup:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
